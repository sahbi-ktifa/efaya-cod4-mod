...
resetServerVariables()
{
	...
	variableNames[ variableNames.size ] = "scr_sr_allow_defender_explosivedestroy scr_sr_allow_defender_explosivedestroy_sound scr_sr_allow_defender_explosivedestroy_time scr_sr_allow_defender_explosivedestroy_win scr_sr_allow_defender_explosivepickup scr_sr_allow_quickdefuse scr_sr_bomb_notification_enable scr_sr_bombsites_enabled scr_sr_bombtimer scr_sr_bombtimer_modifier scr_sr_bombtimer_show scr_sr_defenders_show_both scr_sr_defusetime scr_sr_defusing_sound scr_sr_multibomb scr_sr_objective_takedamage_counter scr_sr_objective_takedamage_enable scr_sr_objective_takedamage_health scr_sr_objective_takedamage_option scr_sr_planting_sound scr_sr_planttime scr_sr_roundlimit scr_sr_roundswitch scr_sr_scoreboard_bomb_carrier scr_sr_scorelimit scr_sr_srmode scr_sr_show_briefcase scr_sr_teambalanceendofround scr_sr_timelimit";
	variableNames[ variableNames.size ] = "scr_sr_dogtag_autoremoval_time scr_sr_enemy_dogtag_score scr_sr_team_dogtag_score scr_score_player_teamkill_sr scr_sr_dogtag_obits scr_sr_denied_player_sound scr_sr_denied_team_sound scr_sr_dogtags_explode_fx scr_sr_dogtag_attacker_owner_score scr_sr_random_second_chance";
