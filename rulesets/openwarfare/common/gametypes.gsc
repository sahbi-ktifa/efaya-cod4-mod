...
init()
{
	...
	//******************************************************************************
	// configs/gametypes/searchandrescue.cfg
	//******************************************************************************
	setDvar( "scr_sr_srmode", "1" );
	setDvar( "scr_sr_bombsites_enabled", "0" );
	setDvar( "scr_sr_defenders_show_both", "0" );
	setDvar( "scr_sr_bomb_notification_enable", "1" );
	setDvar( "scr_sr_bombtimer", "60" );
	setDvar( "scr_sr_bombtimer_modifier", "0" );
	setDvar( "scr_sr_bombtimer_show", "1" );
	setDvar( "scr_sr_defusetime", "8" );
	setDvar( "scr_sr_defusing_sound", "1" );
	setDvar( "scr_sr_multibomb", "0" );
	setDvar( "scr_sr_planting_sound", "1" );
	setDvar( "scr_sr_planttime", "4" );
	setDvar( "scr_sr_roundlimit", "5" );
	setDvar( "scr_sr_roundswitch", "2" );
	setDvar( "scr_sr_scoreboard_bomb_carrier", "0" );
	setDvar( "scr_sr_scorelimit", "3" );
	setDvar( "scr_sr_show_briefcase", "1" );
	setDvar( "scr_sr_timelimit", "4" );
	setDvar( "scr_sr_allow_defender_explosivepickup", "0" );
	setDvar( "scr_sr_allow_defender_explosivedestroy", "0" );
	setDvar( "scr_sr_allow_defender_explosivedestroy_time", "10" );
	setDvar( "scr_sr_allow_defender_explosivedestroy_win", "0" );
	setDvar( "scr_sr_allow_defender_explosivedestroy_sound", "0" );
	setDvar( "scr_sr_allow_quickdefuse", "0" );
	setDvar( "scr_sr_objective_takedamage_enable", "0" );
	setDvar( "scr_sr_objective_takedamage_option", "0" );
	setDvar( "scr_sr_objective_takedamage_counter", "5" );
	setDvar( "scr_sr_objective_takedamage_health", "500" );
	setDvar( "scr_sr_teambalanceendofround", "1" );
	setDvar( "scr_sr_dogtag_autoremoval_time", "15" );
	setDvar( "scr_sr_enemy_dogtag_score", "10" );
	setDvar( "scr_sr_team_dogtag_score", "-5" );
	setDvar( "scr_score_player_teamkill_sr", "-5" );
	setDvar( "scr_sr_dogtag_obits", "1" );
	setDvar( "scr_sr_denied_player_sound", "1" );
	setDvar( "scr_sr_denied_team_sound", "0" );
	setDvar( "scr_allow_leader_dialog_sr", "1" );
	setDvar( "scr_hardcore_show_minimap_sr", "1" );
	setDvar( "scr_hardcore_show_compass_sr", "1" );
        setDvar( "scr_hud_compass_objectives_sr", "0" );
	setDvar( "scr_minimap_show_enemies_firing_sr", "0" );
	setDvar( "scr_sr_show_dogtags_minimap", "0" );
